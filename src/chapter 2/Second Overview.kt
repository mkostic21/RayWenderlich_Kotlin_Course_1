...
fun main(){
  ...
  * */
    ...
    daysOfTheWeek[3] = "Torsdag"

    val mutableDaysOfTheWeek = daysOfTheWeek.toMutableList()
    mutableDaysOfTheWeek.add("Funday")
    mutableDaysOfTheWeek.remove("Monday")

    println(mutableDaysOfTheWeek)

    println("Monday" in mutableDaysOfTheWeek)
}